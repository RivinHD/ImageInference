...
class ImageNet {
    companion object {
        private val imageNetClasses = arrayOf(
            "tench, Tinca tinca",
        ...
        /**
         * Gets the corresponding ImageNet class to an index.
         * To synonymIndex is used to pick a specific class name from the enumeration.
         * E.g. 'box turtle, box tortoise' with synonymIndex = 0 the return value is 'box turtle'
         * and with synonymIndex = 1 it return value is 'box tortoise'.
         *
         * @param index The index of the ImageNet class.
         * @param synonymIndex The optional synonym of the class to pick.
         * If the synonymIndex is higher than the synonym count than the last synonym is returned.
        ...
        fun getClass(index: Int, synonymIndex: Int = 0): String {
            ...
            val synonyms = imageNetClasses[classIndex].split(',')
